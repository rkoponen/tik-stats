...
export const calculateWatchTime = (videoHistory: VideoBrowsingHistoryItem[]): WatchTimeResult => {
  ...
  for (let i = 1; i < videos.length; i++) {
    ...
    const subtstracted = (currentVideo.Date.getTime() - previousVideo.Date.getTime()) / 1000
    if ((subtstracted < 600)) {
  ...
  console.log(`${hours} hrs ${minutes} minutes`)
